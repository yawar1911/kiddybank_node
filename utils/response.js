...
const sendsuccessDataMultipleGame = (res, message, data3, data4, data5, data6, data7) => {
    data = {
        game_details: data3,
        morePrecisely: data4,
...
const sendsuccessCreateGame = (res, message, data3, data4) => {
    data = {
        game_details: data3,
        receiver_id: data4
    }
...
const sendsuccessChatData = (res, message, data3, data4) => {
    data = {
        chatData: data3,
        userDetails: data4
